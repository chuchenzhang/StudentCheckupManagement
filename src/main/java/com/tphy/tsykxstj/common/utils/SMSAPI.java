...
// import tphy.uzfb.verify.bean.MsgModel;
...
//     /// <returns></returns>
//     public CommonReturn SendVerifyCode(String phoneNum)
//     {
...
//         cr = GetMessage(phoneNum, templateCode, json, signName);
//
//         if (cr.getIsSuccess())
//         {
...
//     /// <param name="phoneNum"></param>
//     /// <returns></returns>
//     public static CommonReturn SendMessage(String templateCode,String phoneNum, String verifyCodeJsonFormat)
//     {
//         CommonReturn cr = GetMessage(phoneNum, templateCode, verifyCodeJsonFormat, "天鹏恒宇");
//         return cr;
//     }
//
//     public static CommonReturn GetMessage(String phoneNum, String templateCode, String JsonFormat, String signName)
//     {
//         CommonReturn cr = new CommonReturn();
//
